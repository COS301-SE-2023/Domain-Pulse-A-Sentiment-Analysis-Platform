...
@Component({
  selector: 'commentsAccordion',
  templateUrl: './comments-accordion.component.html',
  styleUrls: ['./comments-accordion.component.sass'],
...
export class CommentsAccordionComponent implements AfterViewInit {
  ...
  @ContentChildren(CommentsAccordionItem) items!: QueryList<CommentsAccordionItem>;
