...
\begin{itemize}
    ...
    \begin{itemize}
        \item We sent all participents of our usability testing a pdf explaining all aspects of navigating to the app and a list of tasks in which they could try.
