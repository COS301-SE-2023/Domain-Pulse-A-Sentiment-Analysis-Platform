...
\begin{itemize}
    ...
    \item \textbf{Vunerable and outdated components} - We have a bot that updates our dependancies automatically and we have no known vunerabilites in our dependancies, we also make use of gitguardian which alerts us if any secrests within the repo somehow get leaked.
\end{itemize}
