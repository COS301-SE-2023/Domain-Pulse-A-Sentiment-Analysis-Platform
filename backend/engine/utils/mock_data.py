# Some reviews about Starbucks Rosebank
starbucks_rosebank_tripadvisor = [
...
# A long news article about Bitcoin
bitcoin_article = [
    """
    Bitcoin (BTC) maintained trading marginally lower and remained below $27,000 on Wednesday as investors closely watched for indications of the U.S. economy. According to data from CoinMarketCap, the biggest cryptocurrency by market capitalization is currently trading at $26,701, down around 1.3% for the day. BTC's price has been fluctuating between $26,572 and $27,234 over the last 24 hours. In light of this, crypto analyst Ali Martinez highlights the important levels to pay attention to that might mark the next direction for the Bitcoin price. In a new tweet, Ali notes that all eyes are on the most important support level at $26,490, as failing to hold above here might trigger a steeper correction to $24,100 or $23,190. On the upside, Bitcoin faces stiff resistance, especially between $28,180 and $28,990, where 1.24 million addresses bought 973,220 BTC. The trend of accumulation is spotted among Bitcoin whales, categorically, those who own 1,000 to 10,000 BTC. On-chain analytics firm Santiment reports that these large Bitcoin holders have accumulated 84,897 in the past five weeks. "Bitcoin's key large whale address tier has been on a steady accumulation run over the past 5 weeks, accumulating a combined 84,897 BTC during this time while prices are stagnant. In their previous accumulation cycle in January, prices jumped +34.4%," Santiment analysts wrote while highlighting the potential of a price increase from current levels. In positive news for BTC, Tether — the company managing the reserves of the biggest stablecoin, USDT — has shared its new investment strategy.
    """
]


# A couple reviews about The Witcher 3 pulled from Reddit
the_witcher_reviews_reddit = [
...
"Are there any extremely critical reviews of the game? I feel like you always learn a lot more about what the experience is going to be like when you hear from someone who wasn't the biggest fan."
]



# Some data gathered from reddit about Lance Stroll
lance_reddit_data = [
    "In short, yes he got into F1 through his dad’s money.He’s also a decent midfield level talent who deserves his seat, even if he makes some really stupid/clumsy mistakes at times.He’s nowhere close to being the level of second-hand embarrassment pay drivers we’ve seen through the decades.Personality, seems nice enough if somewhat introverted. Seems to have no great love of talking to the media but given the shit they’ve given him over the years, can’t really blame him there.",
    """
    He's a decent driver, his dad is a billionaire who bought his seat, then he bought a team when it lost its funding.

Then turned it into Aston Martin.

Lance has never had much of a personality, and he's made a few mistakes (who hasn't), but he overall seems like a decent guy and a decent driver.

Just remember, if you're decent in F1, it means you're one of the top drivers in the world.

He absolutely received opportunities others wouldn't, but he's definitely made the most of them in F1 and hasn't sat on his yacht sipping champagne with a bunch of supermodels, which he absolutely could have done.""",
"Did money get him to F1? Undoubtedly? Does money or connections get MOST drivers into F1? Absolutely yes. I think Daniel Ricciardo said it best- money got him onto the grid, but his talent shows that he deserves to be there. I think that his introversion and awkwardness sometimes further the negative stereotypes, unfortunately.",
"He’s a talented driver - got a podium in his rookie season with Williams and is usually there or there about with his teammate (we’ll see how he gets on against Alonso) - he is definitely on the grid and in his seat because of his Dad, but he has also proved time and time again he deserves to be there"
