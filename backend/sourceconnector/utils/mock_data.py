MOCK_DATA = {
    "0": [
        "Really wish I had read reviews before going there to host an event👎👎👎honestly I don't think you can take serving starters that we didn't order and giving people food they're allergic to even after stating their allergies as a misunderstanding of what you offer, unless that's the type of service you give people.",
        "As a joburger, I’m so jealous that this Goddess cafe is so much better , definitely worth the drive. Amazing waiters and I had the best quiche ever! The ladies certainly felt like Goddesses! How cool are the hats that my niece made!?😍 she couldn’t stop bragging to her friends about her experience.",
    ...
    "1": [
        ...
        "Goddess Café, a beautiful restaurant with excellent service. Only problem with the restaurant is the step you wil be needing to take to enter the restaurant area. The step is to high for the older customers of Goddess Café and so the step is oftenly missed, causing customers to fall to the ground and get badly hurt. I hope the owner and management of the restaurant will take my review under advisement and solve the problem so the Goddess Café restaurant may be enjoyed by women of all ages.",
    ...
    "3": [
        "Caps off another shocking embarrassing disgraceful season , wasted everyone’s time",
